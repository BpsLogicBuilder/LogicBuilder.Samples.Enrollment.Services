...
namespace Enrollment.Api.Controllers
{
    ...
    [ApiController]
    public class AcademicController(IHttpClientHelper httpClientHelper, IOptions<UrlOptions> optionsAccessor) : ControllerBase
    {
