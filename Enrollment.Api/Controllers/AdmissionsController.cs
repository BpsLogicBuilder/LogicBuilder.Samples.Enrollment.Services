...
namespace Enrollment.Api.Controllers
{
    ...
    [ApiController]
    public class AdmissionsController(IHttpClientHelper httpClientHelper, IOptions<UrlOptions> optionsAccessor) : ControllerBase
    {
