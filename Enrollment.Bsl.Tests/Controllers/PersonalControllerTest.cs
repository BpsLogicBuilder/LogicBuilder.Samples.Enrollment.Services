...
namespace Enrollment.Bsl.Tests.Controllers
{
    ...
    {
        static PersonalControllerTest()
        {
            InitializeMapperConfiguration();
        }

        public PersonalControllerTest(DatabaseFixture databaseFixture, ITestOutputHelper output)
        {
        ...
        public async Task SavePersonal()
        {
            ...
            PersonalController controller = new(flowManager);
            var result = (OkObjectResult)controller.Save(new SaveEntityRequest { Entity = personal });
            stopWatch.Stop();
            ...
            PersonalModel model = (PersonalModel)((SaveEntityResponse)result.Value!).Entity!;
        ...
        public async Task DeleteValidPersonalRequest()
        {
            ...
            System.Diagnostics.Stopwatch stopWatch = System.Diagnostics.Stopwatch.StartNew();
            PersonalController controller = new(flowManager);
            var result = (OkObjectResult)controller.Delete(new DeleteEntityRequest { Entity = personal });
            stopWatch.Stop();
