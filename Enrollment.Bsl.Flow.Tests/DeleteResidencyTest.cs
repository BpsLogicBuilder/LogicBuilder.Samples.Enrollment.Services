...
namespace Enrollment.Bsl.Flow.Tests
{
    ...
    {
        static DeleteResidencyTest()
        {
            InitializeMapperConfiguration();
        }

        public DeleteResidencyTest(DatabaseFixture databaseFixture, ITestOutputHelper output)
        {
        ...
        public async Task DeleteResidencyNotFoundRequest()
        {
            ...
            residency = (await enrollmentRepository.GetAsync<ResidencyModel, Residency>(s => s.UserId == 1)).SingleOrDefault();
